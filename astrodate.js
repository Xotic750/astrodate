                ...
                toString: {
                    value: function (lang) {
                        ...
                        if (this.isValid()) {
                            ...
                            date = languages[lang].calendars.gregorian.dateFormats.full.replace(/\bEEEE\b/, this.dayOfWeek('wide', lang)).replace(/\bd\b/, struct.day.toString()).replace(/\bMMMM\b/, this.monthOfYear('wide', lang)).replace(/\by\b/, year).replace(/\'/g, '');
                            ...
                            time = languages[lang].calendars.gregorian.timeFormats.full.replace(/\bh\b/, hour1).replace(/\bH\b/, hour2).replace(/\bHH\b/, hour3).replace(/\bmm\b/, struct.minute.padLeadingZero(2)).replace(/\bss\b/, struct.second.padLeadingZero(2)).replace(/\ba\b/, dayPeriod).replace(/\bzzzz\b/, zone).replace(/\'/g, '');
