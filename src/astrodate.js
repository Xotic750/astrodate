...
*/
     ...
     * @return {boolean}
     */
    function checkObjectCoercible(inputArg, msg) {
        if (isUndefined(inputArg) || isNull(inputArg)) {
            msg = msg || '';
            throw new TypeError(msg + ': Cannot convert "' + inputArg + '" to object');
        }
    ...
    toObject = (function () {
        ...
        tempSafariNFE = function nfeToObject(inputArg) {
            var object = checkObjectCoercible(inputArg, 'toObject');
...
*/
    ...
    stringSplit = (function () {
        ...
        tempSafariNFE = function nfeSplit(str, separator, limit) {
            var string = anyToString(checkObjectCoercible(str, 'stringSplit')),
                output,
                flags,
                lastLastIndex,
                separator2,
    ...
    function firstChar(inputArg) {
        return anyToString(checkObjectCoercible(inputArg, 'firstChar')).charAt(0);
    }
    ...
    function lastChar(inputArg) {
        var thisStr = anyToString(checkObjectCoercible(inputArg, 'lastChar'));
    ...
    function countCharacter(inputArg, character) {
        return clamp(stringSplit(anyToString(checkObjectCoercible(inputArg, 'countCharacter')), firstChar(character)).length - 1, 0, Number.POSITIVE_INFINITY);
    }
    ...
    function padLeadingChar(inputArg, character, size) {
        var string = anyToString(checkObjectCoercible(inputArg, 'padLeadingChar')),
    ...
    stringRepeat = (function () {
        ...
        if (isFunction(repeatFN)) {
            ...
            tempSafariNFE = function nfeRepeat(string, count) {
                var thisString = anyToString(checkObjectCoercible(string, 'stringRepeat')),
...
stringStartsWith = (function () {
    ...
    if (isFunction(startsWithFN)) {
        ...
        tempSafariNFE = function nfeStartsWith(string, searchString, position) {
            var thisStr = anyToString(checkObjectCoercible(string, 'stringStartsWith')),
...
stringEndsWith = (function () {
    ...
    if (isFunction(endsWithFN)) {
        ...
        tempSafariNFE = function nfeEndsWith(string, searchString, position) {
            var thisStr = anyToString(checkObjectCoercible(string, 'stringEndsWith')),
                searchStr = anyToString(searchString),
                thisLen = thisStr.length,
                end,
                start;
...
*/
    ...
    stringContains = (function () {
        ...
        if (isFunction(containsFN)) {
            ...
            tempSafariNFE = function nfeContains(string, searchString, position) {
                var thisStr = anyToString(checkObjectCoercible(string, 'stringContains')),
                    searchStr = anyToString(searchString),
                    thisLen = thisStr.length;
...
*/
    ...
    stringTrim = (function () {
        ...
        if (isFunction(trimFN) && isZero(trimFN.call(testString).length)) {
            ...
            tempSafariNFE = function nfeTrim(inputArg) {
                return anyToString(checkObjectCoercible(inputArg, 'stringTrim')).replace(wsTrimRX, '');
            };
        }
    ...
    function defineAstroDate(BigNumber) {
        ...
        */
        ...
        function cldrPadLeadingZero(num, size) {
            var strNum = anyToString(checkObjectCoercible(num, 'cldrPadLeadingZero')),
                firsrCharacter,
                val;
        ...
        */
         ...
         * new AstroDate(year, month [, day, hour, minute, second, millisecond]);
         * </code></pre>
         * <ul>
         * <li><b>value</b><br>
         ...
         *
         * // An AstroDate object.
         * new AstroDate(new AstroDate(1995, 12, 17, 3, 24, 0, 0));
         *
         * // Using an arguments list.
         * new AstroDate(1995, 12, 17, 3, 24, 0, 0);
         * new AstroDate('1995', '12', '17', '3', '24', '0', '0');
         */
        function AstroDate() {
            var args = arguments,
