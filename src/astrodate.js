...
*/
    ...
    toObjectString = (function () {
        ...
        try {
            tempSafariNFE = privateUndefined;
...
*/
    ...
    boxedString = baseObject.constructor('a');
        ...
        if (isFunction(keysFN)) {
            ...
            tempSafariNFE = function nfeKeys(object) {
                if (!isTypeObject(object) && !isFunction(object)) {
                    throw new TypeError('Object.keys called on a non-object:' + object);
                }
