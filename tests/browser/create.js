(function (thisContext) {
    ...
    function runTests(AstroDate, mocha, chai) {
        mocha.setup({
            ui: 'bdd',
            reporter: 'tap'
        });
    ...
    if ('object' === typeof module && null !== module && 'object' === typeof module.exports && null !== module.exports) {
        runTests(require('../../lib/astrodate'), require('mocha'), require('chai'));
    } else if ('function' === typeof define && 'object' === typeof define.amd && null !== define.amd) {
        require.config({
            paths: {
                astrodate: 'https://raw.github.com/Xotic750/astrodate/master/lib/astrodate.js',
                mocha: 'https://raw.github.com/visionmedia/mocha/master/mocha.js',
                chai: 'http://chaijs.com/chai.js'
            }
        });

        define(['astrodate', 'mocha', 'chai'], runTests);
    } else {
        runTests(thisContext.AstroDate, thisContext.mocha, thisContext.chai);
    }
}(this));
